...
public class Recipes_jungle {
	...
	public static void registerRecipes(AddSomeFurniture addSomeFurniture) 
	{
		...
		recipe.setIngredient('A', MaterialData.jungleWood);
		...
		recipe.setIngredient('B', MaterialData.jungleWood);
		SpoutManager.getMaterialManager().registerSpoutRecipe(recipe);
		...
		recipe.shape("AAA", "BBB");
		recipe.setIngredient('A', MaterialData.jungleLog);
		recipe.setIngredient('B', MaterialData.jungleWood);
		SpoutManager.getMaterialManager().registerSpoutRecipe(recipe);
		...
		recipe.setIngredient('B', MaterialData.jungleLog);
