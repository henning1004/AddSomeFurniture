...
public class Recipes_spruce {
	...
	public static void registerRecipes(AddSomeFurniture addSomeFurniture) 
	{
		...
		recipe.setIngredient('A', MaterialData.spruceWood);
		...
		recipe.setIngredient('B', MaterialData.spruceWood);
		SpoutManager.getMaterialManager().registerSpoutRecipe(recipe);
		...
		recipe.shape("AAA", "BBB");
		recipe.setIngredient('A', MaterialData.spruceLog);
		recipe.setIngredient('B', MaterialData.spruceWood);
		SpoutManager.getMaterialManager().registerSpoutRecipe(recipe);
		...
		recipe.setIngredient('B', MaterialData.spruceLog);
